package com.zvosframework.schedule.admin.scheduler.config;

import com.zvosframework.schedule.admin.mapper.*;
import com.zvosframework.schedule.admin.scheduler.alarm.JobAlarmer;
import com.zvosframework.schedule.admin.scheduler.complete.JobCompleter;
import com.zvosframework.schedule.admin.scheduler.thread.*;
import com.zvosframework.schedule.admin.scheduler.trigger.JobTrigger;
...
public class JobAdminBootstrap implements InitializingBean, DisposableBean {
    ...
    public static ExecutorBiz getExecutorBiz(String address) throws Exception {
        ...
        executorBiz = HttpTool.createClient()
                .url(address)
                .timeout(JobAdminBootstrap.getInstance().getTimeout() * 1000)
                .header(Const.XXL_JOB_ACCESS_TOKEN, JobAdminBootstrap.getInstance().getAccessToken())
