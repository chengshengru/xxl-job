package com.zvosframework.schedule.core.log;
...
public class JobFileAppender {
	...
	public static String makeLogFileName(Date triggerDate, long logId) {
        ...
        try {
            ...
            throw new RuntimeException("JobFileAppender makeLogFileName error, logFilePath:"+ logFilePath.getPath(), e);
        }
	...
	public static void appendLog(String logFileName, String appendLog) {
        ...
        try {
            ...
            throw new RuntimeException("JobFileAppender appendLog error, logFileName:"+ logFileName, e);
        }
	}
	...
	public static LogResult readLog(String logFileName, final int fromLineNum){
        ...
        try {
            ...
            logger.error("JobFileAppender readLog error, logFileName:{}, fromLineNum:{}", logFileName, fromLineNum, e);
        }
