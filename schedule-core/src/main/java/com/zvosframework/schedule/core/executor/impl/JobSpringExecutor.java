...
public class JobSpringExecutor extends JobExecutor implements ApplicationContextAware, SmartInitializingSingleton, DisposableBean {
    ...
    public TriggerCallbackThread getTriggerCallbackThread() {
        ...
        try {
            java.lang.reflect.Field field = JobExecutor.class.getDeclaredField("triggerCallbackThread");
    ...
    public JobLogFileCleanThread getJobLogFileCleanThread() {
        // use reflection to access private field
        try {
            java.lang.reflect.Field field = JobExecutor.class.getDeclaredField("jobLogFileCleanThread");
            field.setAccessible(true);
    ...
    public ExecutorRegistryThread getExecutorRegistryThread() {
        // use reflection to access private field
        try {
            java.lang.reflect.Field field = JobExecutor.class.getDeclaredField("executorRegistryThread");
            field.setAccessible(true);
