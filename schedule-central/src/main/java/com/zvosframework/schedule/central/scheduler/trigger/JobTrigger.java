package com.zvosframework.schedule.central.scheduler.trigger;
...
public class JobTrigger {
    ...
    private void processTrigger(JobGroup group,
        ...
        triggerMsgSb.append("<br>").append(I18nUtil.getString("jobconf_trigger_central_adress")).append("：").append(IPTool.getIp());
