...
import com.zvosframework.schedule.core.openapi.model.KillRequest;
import com.zvosframework.schedule.core.openapi.model.LogRequest;
import com.zvosframework.schedule.core.openapi.model.LogResult;
...
public class JobLogController {
	...
	public Response<String> logKill(HttpServletRequest request, @RequestParam("id") long id){
		...
		try {
			ExecutorBiz executorBiz = JobCentralBootstrap.getExecutorBiz(log.getExecutorAddress());
	...
	public Response<LogResult> logDetailCat(@RequestParam("logId") long logId, @RequestParam("fromLineNum") int fromLineNum){
		try {
			...
			// log cat
			ExecutorBiz executorBiz = JobCentralBootstrap.getExecutorBiz(jobLog.getExecutorAddress());
