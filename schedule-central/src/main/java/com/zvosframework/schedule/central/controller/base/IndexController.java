package com.zvosframework.schedule.central.controller.base;

import com.zvosframework.schedule.central.constant.Consts;
import com.zvosframework.schedule.central.model.dto.BootResourceDTO;
...
public class IndexController {
	...
	private List<BootResourceDTO> findResourceList(HttpServletRequest request){
		...
		List<BootResourceDTO> resourceDTOList = Arrays.asList(
				...
				new BootResourceDTO(9, 0, I18nUtil.getString("central_help"),1, "", "/help", "fa-book", 6, 0, null)
		);
