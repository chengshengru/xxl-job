package com.zvosframework.schedule.central.scheduler.openapi;
...
public class OpenApiController {
    ...
    public Object api(HttpServletRequest request,
        ...
        // valid token
        if (StringTool.isNotBlank(JobCentralBootstrap.getInstance().getAccessToken())
                && !JobCentralBootstrap.getInstance().getAccessToken().equals(accesstoken)) {
