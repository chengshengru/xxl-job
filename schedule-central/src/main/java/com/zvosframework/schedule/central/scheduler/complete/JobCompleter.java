package com.zvosframework.schedule.central.scheduler.complete;
            ...
            if (xxlJobInfo!=null && StringTool.isNotBlank(xxlJobInfo.getChildJobId())) {
                ...
                for (int i = 0; i < childJobIds.length; i++) {
                    ...
                    if (childJobId > 0) {
                        ...
                        // trigger child job
                        JobCentralBootstrap.getInstance().getJobTriggerPoolHelper().trigger(childJobId, TriggerTypeEnum.PARENT, -1, null, null, null);
