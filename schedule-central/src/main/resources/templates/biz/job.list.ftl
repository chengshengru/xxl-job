...
<script src="${request.contextPath}/static/plugins/bootstrap-table/locale/<#if I18n.central_i18n?? && I18n.central_i18n == 'en'>bootstrap-table-en-US.min.js<#else>bootstrap-table-zh-CN.min.js</#if>"></script>
<#-- admin table -->
...
<#-- cronGen -->
<script src="${request.contextPath}/static/plugins/cronGen/<#if I18n.central_i18n?? && I18n.central_i18n == 'en'>cronGen_en.js<#else>cronGen.js</#if>"></script>
<script>
	$(function() {
