...
<div class="wrapper" >
	...
	<footer class="main-footer">
		Powered by <b>SCHEDULE-JOB</b> ${I18n.central_version}
...
<script src="${request.contextPath}/static/biz/common/admin.setting.js?v=${I18n.central_version}"></script>
<#-- glue ide -->
