...
public class AIJob {
    ...
    public void ollamaJobHandler() {
        ...
        try {
            ...
            JobHelper.log(new RuntimeException("OllamaParam parse error", e));
            JobHelper.handleFail();
            return;
        }

        // input
        JobHelper.log("<br><br><b>【Input】: " + ollamaParam.getInput()+ "</b><br><br>");
        ...
        JobHelper.log("<br><br><b>【Output】: " + response + "</b><br><br>");
    }
    ...
    public void difyWorkflowJobHandler() throws Exception {
        ...
        try {
            ...
            if (difyParam.getBaseUrl()==null || difyParam.getApiKey()==null) {
                JobHelper.log("baseUrl or apiKey invalid.");
                JobHelper.handleFail();
                return;
            }
        } catch (Exception e) {
            JobHelper.log(new RuntimeException("DifyParam parse error", e));
            JobHelper.handleFail();
            return;
        }
        ...
        // dify param
        JobHelper.log("<br><br><b>【inputs】: " + difyParam.getInputs() + "</b><br><br>");
        ...
        // response
        JobHelper.log("<br><br><b>【Output】: " + response.getData().getOutputs()+ "</b><br><br>");
    }
    ...
    public void openClawJobHandler() {
        ...
        try {
            ...
            JobHelper.log(new RuntimeException("OpenclawParam parse error", e));
            JobHelper.handleFail();
            return;
        }

        // input
        JobHelper.log("<br><br><b>【Input】: " + openClawParam.getInput()+ "</b><br><br>");
